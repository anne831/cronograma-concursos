...
import { LayoutDashboard, CalendarDays, RefreshCw, PencilLine, StickyNote, ClipboardList, Building2, LogOut } from 'lucide-react';
...
const navItems = [
  ...
  { id: 'anotacoes', icon: <StickyNote size={20} />, label: 'Anotações' },
